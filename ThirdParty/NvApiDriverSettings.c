...
EValues_PS_SHADERDISKCACHE_FLAGS g_valuesPS_SHADERDISKCACHE_FLAGS[PS_SHADERDISKCACHE_FLAGS_NUM_VALUES] = 
{
    ...
    PS_SHADERDISKCACHE_FLAGS_BACKEND_SQLITE,
...
SettingDWORDNameString mapSettingDWORD[TOTAL_DWORD_SETTING_NUM] = 
{
    ...
    {PS_SHADERDISKCACHE_FLAGS_ID,          PS_SHADERDISKCACHE_FLAGS_STRING,          21, (NvU32 *)g_valuesPS_SHADERDISKCACHE_FLAGS, 0x00000000},
